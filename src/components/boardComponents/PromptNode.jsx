...
const PromptNode = ({ data }) => {
	...
	return (
		<div onClick={data.onClick}
			ref={nodeRef}
			className='prompt-node' style={{ backgroundColor: data.backgroundColor || '#FFF' }}
		>
			...
			<div className="prompt-node-header">
				<Typography variant="subtitle2" className="prompt-node-title" style={{ fontFamily: 'Poppins, sans-serif' }}>
					{data.label}
				</Typography>
			</div>
